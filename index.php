...
function get_tag_id($tag) {
  $tag_id = false;
  $tag_select = run_query(
    'SELECT id FROM tags WHERE title = \''.$tag.'\''
  );
...
function insert_tag_note($tag_id, $note_id) {
  ...
  $tag_note_count = run_query(
    'SELECT COUNT(*) AS count FROM tag_note '.
